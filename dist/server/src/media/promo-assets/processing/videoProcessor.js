...
import { generatePromoThumbnail } from "./thumbnailGenerator.js";
import { extractVideoMetadata } from "./videoMetadata.js";
...
export class PromoAssetVideoProcessor {
    ...
    ffmpeg;
    platformValidation;
    constructor(supabase, storage, ffmpeg, platformValidation) {
    ...
    async process(assetId, onProgress = async () => undefined) {
    ...
    async transcodeOptimizedMp4(inputPath, outputPath) {
    ...
    async updateAsset(assetId, metadata, thumbnailUrl, optimizedUrl) {
