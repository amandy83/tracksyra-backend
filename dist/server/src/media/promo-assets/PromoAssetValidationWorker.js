...
import { isPromoAssetType } from "./promoAssetRules.js";
export class PromoAssetValidationWorker {
    supabase;
    storage;
    validator;
    constructor(supabase, storage, validator) {
    ...
    async validateAsset(assetId) {
        ...
        if (!isPromoAssetType(asset.asset_type))
            throw new Error(`Unsupported promo asset type ${asset.asset_type}.`);
