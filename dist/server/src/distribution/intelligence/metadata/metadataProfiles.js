const DEFAULT_RELEASE_KINDS = ["single", "ep", "album", "compilation", "multi_disc", "instrumental"];
...
function createProfile(platform, input) {
...
export const METADATA_DSP_PROFILES = Object.freeze({
...
export function listMetadataDspProfiles() {
