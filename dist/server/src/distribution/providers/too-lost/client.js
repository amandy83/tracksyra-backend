import { createTooLostAuthorizationUrl, exchangeTooLostAuthorizationCode, refreshTooLostAccessToken, resolveTooLostOAuthEnvironment, TOO_LOST_AUTHORIZATION_URL, TOO_LOST_DEFAULT_SCOPES, TOO_LOST_TOKEN_URL, } from "./oauth.js";
export class TooLostAuthClient {
    ...
    async loginUrl(additionalParams = {}) {
    ...
    async refreshToken() {
        this.ensureCredentials();
        return this.tokenManager.refreshToken((refreshToken) => refreshTooLostAccessToken({
            refreshToken,
            clientId: this.clientId,
            clientSecret: this.clientSecret,
            tokenUrl: this.tokenUrl,
    ...
    async getAccessToken() {
        this.ensureCredentials();
        return this.tokenManager.getAccessToken((refreshToken) => refreshTooLostAccessToken({
            refreshToken,
            clientId: this.clientId,
            clientSecret: this.clientSecret,
            tokenUrl: this.tokenUrl,
    ...
    createAuthorizedRequest(input, init, accessToken) {
