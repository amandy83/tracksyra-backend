import { applyBasisPoints, decimalUsdToMicros, microsToDecimalUsd, percentageToBasisPoints } from "./money.js";
export class SplitDistributionEngine {
    deps;
    constructor(deps) {
        this.deps = deps;
    }
    async calculateSplitDistribution(royaltyRecord) {
        ...
        const totalBasisPoints = effectiveSplits.reduce((sum, split) => sum + percentageToBasisPoints(split.percentage_share), 0n);
