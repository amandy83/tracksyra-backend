...
export function setEmailDeliveryLogger(logger) {
...
export async function sendQueuedEmail(payload) {
...
async function sendEmailOnce(payload) {
...
function ensureBrandedHtml(subject, html) {
...
async function sendRawSmtp(config, payload) {
...
function buildMimeMessage(config, payload) {
